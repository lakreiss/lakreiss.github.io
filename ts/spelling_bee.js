...
function initialize_dictionary() {
    ...
    var requestURL = '../files/english_dictionary.json';
...
function set_letters(outside_letters, center_letter, randomize) {
...
function update_cur_word(new_word) {
    if (new_word === void 0) { new_word = cur_word; }
    cur_word = new_word;
