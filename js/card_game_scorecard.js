...
var player_names = [];
var player_scores = [];
function build_card_game_scorecard() {
...
function start_game() {
    ...
    for (var i = 0; i < all_name_inputs.length; i++) {
        var cur_name_input = all_name_inputs[i];
...
function save() {
    ...
    for (var i = 0; i < all_score_inputs.length; i++) {
        var cur_score_input = all_score_inputs[i];
...
//# sourceMappingURL=card_game_scorecard.js.map